...
/**
 * Serializes operating system part of the agentInfo file for agent based Windows systems.
 *
 * @author John Roland <jroland@datto.com>
 */
class LegacyWindowsOperatingSystemSerializer implements Serializer
{
    /**
