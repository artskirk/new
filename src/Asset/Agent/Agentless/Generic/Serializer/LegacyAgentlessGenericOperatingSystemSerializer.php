...
/**
 * Serializes operating system part of the agentInfo file for agentless generic systems.
 *
 * @author Michael Corbeil <mcorbeil@datto.com>
 */
class LegacyAgentlessGenericOperatingSystemSerializer implements Serializer
{
    /**
    ...
    public function unserialize($agentInfo)
    {
        ...
        return new OperatingSystem(OsFamily::UNKNOWN(), $name, $version, $architecture, $bits, $servicePack, $kernel);
    }
}
