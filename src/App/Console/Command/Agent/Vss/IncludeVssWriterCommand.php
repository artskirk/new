...
class IncludeVssWriterCommand extends AbstractAgentCommand
{
    protected static $defaultName = 'agent:vss:include';

    protected function configure()
    {
        $this
            ->addArgument('writer-id', InputArgument::REQUIRED, 'VSS Writer ID to include');
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($agents as $agent) {
            ...
            $agent->getVssWriterSettings()->includeWriter($vssWriterId);
