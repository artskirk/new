 ...
 */
class LegacyAgentlessWindowsSerializer implements Serializer
{
    ...
    public function __construct(
        ...
        LegacyAgentlessWindowsOperatingSystemSerializer $operatingSystemSerializer = null,
        ...
        $this->operatingSystemSerializer = $operatingSystemSerializer ?? new LegacyAgentlessWindowsOperatingSystemSerializer();
    ...
    public function serialize($agent)
    {
        $agentInfo = array(
            ...
            'ram' => $agent->getMemory(),
            'type' => AssetType::AGENTLESS_WINDOWS,
            'volumes' => $agent->getVolumes()->toArray()
        );

        if ($agent->getFullyQualifiedDomainName() !== null) {
            $agentInfo['fqdn'] = $agent->getFullyQualifiedDomainName();
        }
    ...
    public function unserialize($fileArray)
    {
        ...
        $fqdn = isset($agentInfo['fqdn']) ? $agentInfo['fqdn'] : null;
